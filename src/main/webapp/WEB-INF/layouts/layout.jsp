...
<script src="<sring:url value='/js/jquery/jquery.metadata.js'/>" type="text/javascript"></script>
<script src="<sring:url value='/js/application.js'/>" type="text/javascript"></script>
<html>
<head>
